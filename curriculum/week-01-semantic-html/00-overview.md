...
| [resources.md](./01-resources.md) | Curated readings, the HTML Living Standard, MDN, WCAG 2.2, axe DevTools |
| [lecture-notes/01-what-html-actually-is.md](./02-lecture-notes/01-what-html-actually-is.md) | HTML as a tree, the document skeleton, validation, why div soup is bad |
| [lecture-notes/02-semantics-headings-landmarks-a11y.md](./02-lecture-notes/02-semantics-headings-landmarks-a11y.md) | Landmarks, headings, lists, forms, images, accessibility |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-build-a-real-page.md](./03-exercises/exercise-01-build-a-real-page.md) | Mark up an article page from a plain-text source |
| [exercises/exercise-02-fix-the-bad-html.md](./03-exercises/exercise-02-fix-the-bad-html.md) | Take a div-soup page and rewrite it semantically |
| [exercises/exercise-03-validate-and-audit.md](./03-exercises/exercise-03-validate-and-audit.md) | Run validator.w3.org and axe DevTools and fix every issue |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-recreate-a-real-page.md](./04-challenges/challenge-01-recreate-a-real-page.md) | HTML-only recreation of a real news article |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for the 5-page personal site, HTML only |
