...
If under 7, re-read [Lecture 1](./02-lecture-notes/01-the-dom-tree-and-querying.md) and [Lecture 2](./02-lecture-notes/02-events-delegation-and-focus.md). If 9 or above, you are ready for the [homework](./06-homework.md).
