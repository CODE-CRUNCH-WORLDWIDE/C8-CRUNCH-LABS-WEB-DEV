...
| [resources.md](./01-resources.md) | MDN, the DOM Living Standard, WCAG 2.2, the ARIA Authoring Practices, screen-reader manuals |
| [lecture-notes/01-the-dom-tree-and-querying.md](./02-lecture-notes/01-the-dom-tree-and-querying.md) | The tree, the four common node types, querying with CSS selectors, mutating without `innerHTML`, the four interfaces (attribute, property, class, style) |
| [lecture-notes/02-events-delegation-and-focus.md](./02-lecture-notes/02-events-delegation-and-focus.md) | `addEventListener`, the three phases, delegation, focus management, the keyboard model, ARIA basics, the Authoring Practices |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-query-and-mutate.md](./03-exercises/exercise-01-query-and-mutate.md) | Drills on querying and mutating a small page; no events yet |
| [exercises/exercise-02-event-delegation.md](./03-exercises/exercise-02-event-delegation.md) | Turn ten per-item listeners into one delegated listener; measure the difference |
| [exercises/exercise-03-keyboard-navigable-dropdown.md](./03-exercises/exercise-03-keyboard-navigable-dropdown.md) | Build the warm-up dropdown: a disclosure button + a list of links, keyboard-driven |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-aria-rich-listbox.md](./04-challenges/challenge-01-aria-rich-listbox.md) | Build an ARIA listbox following the Authoring Practices end-to-end |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | An accessible custom dropdown with full keyboard navigation + screen-reader testing |
