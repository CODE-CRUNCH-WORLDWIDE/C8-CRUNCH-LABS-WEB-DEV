...
Then start the [mini-project](../07-mini-project/00-overview.md) — which is this app, polished, with filters, full accessibility, and a README a stranger could follow.
