...
If under 7, re-read [Lecture 1](./02-lecture-notes/01-types-control-flow-functions.md) and [Lecture 2](./02-lecture-notes/02-scope-closures-and-modules.md). If 9 or above, you are ready for the [homework](./06-homework.md).
