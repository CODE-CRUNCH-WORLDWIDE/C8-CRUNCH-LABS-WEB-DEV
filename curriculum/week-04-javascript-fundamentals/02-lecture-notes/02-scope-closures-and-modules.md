...
Next: do the exercises in [exercises/](../03-exercises/), take the [quiz](../05-quiz.md), pick the [challenge](../04-challenges/challenge-01-build-a-todo-app-no-framework.md), and ship the [mini-project](../07-mini-project/00-overview.md).
