...
If under 7, re-read [Lecture 1](./02-lecture-notes/01-flexbox-mental-model.md) and [Lecture 2](./02-lecture-notes/02-grid-and-when-to-use-which.md). If 9 or above, you are ready for the [homework](./06-homework.md).
