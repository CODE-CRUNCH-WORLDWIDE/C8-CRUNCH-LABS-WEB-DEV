...
| [resources.md](./01-resources.md) | The CSS-Tricks complete guides, the specs, MDN, the layout inspectors |
| [lecture-notes/01-flexbox-mental-model.md](./02-lecture-notes/01-flexbox-mental-model.md) | Flexbox from the main axis outward; the eight properties you actually use |
| [lecture-notes/02-grid-and-when-to-use-which.md](./02-lecture-notes/02-grid-and-when-to-use-which.md) | Grid tracks, areas, and the Flexbox-vs-Grid decision |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-card-grid.md](./03-exercises/exercise-01-card-grid.md) | A responsive card grid with `auto-fit, minmax(...)` and no media query |
| [exercises/exercise-02-holy-grail-layout.md](./03-exercises/exercise-02-holy-grail-layout.md) | The classic header / nav / main / aside / footer layout with `grid-template-areas` |
| [exercises/exercise-03-fluid-image-gallery.md](./03-exercises/exercise-03-fluid-image-gallery.md) | An accessible image gallery with `srcset`, `sizes`, and aspect ratio |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-recreate-a-news-homepage.md](./04-challenges/challenge-01-recreate-a-news-homepage.md) | Rebuild a news site's homepage at three viewport widths |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Make your Week-1 site fully responsive from 320 px to 1440 px |
