...
| [resources.md](./01-resources.md) | Curated readings, the CSS specs, MDN, the contrast tools |
| [lecture-notes/01-the-cascade-specificity-inheritance.md](./02-lecture-notes/01-the-cascade-specificity-inheritance.md) | The cascade, selectors, specificity, inheritance, the box model |
| [lecture-notes/02-custom-properties-color-typography.md](./02-lecture-notes/02-custom-properties-color-typography.md) | Custom properties, color spaces, fluid type, system fonts, dark mode |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of exercises |
| [exercises/exercise-01-style-week1-page.md](./03-exercises/exercise-01-style-week1-page.md) | Apply CSS to your Week 1 essay page |
| [exercises/exercise-02-fluid-typography.md](./03-exercises/exercise-02-fluid-typography.md) | Build a `clamp()`-based type scale |
| [exercises/exercise-03-custom-properties-theme.md](./03-exercises/exercise-03-custom-properties-theme.md) | Token-driven theme with a dark-mode override |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-recreate-a-magazine-spread.md](./04-challenges/challenge-01-recreate-a-magazine-spread.md) | Rebuild a magazine article's typography with no images |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Style your Week-1 personal site, no frameworks |
