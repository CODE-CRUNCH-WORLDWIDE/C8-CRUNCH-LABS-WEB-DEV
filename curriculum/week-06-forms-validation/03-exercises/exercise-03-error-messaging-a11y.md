...
If every assertion above is green and your `NOTES.md` documents the screen-reader test, commit this folder to your Week 6 repo and you are ready for the [mini-project](../07-mini-project/00-overview.md).
