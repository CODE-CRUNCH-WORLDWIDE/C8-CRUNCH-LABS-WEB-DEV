...
If under 7, re-read [Lecture 1](./02-lecture-notes/01-html5-form-semantics.md) and [Lecture 2](./02-lecture-notes/02-validation-error-messaging-autofill.md). If 9 or above, you are ready for the [homework](./06-homework.md).
