...
<BaseLayout title="Crunch Portfolio — Home" description="A learner web-development portfolio.">
  <section class="hero">
...
<BaseLayout title="About — Crunch Portfolio" description="About the author.">
  <h1>About</h1>
  <p>
    I am a learner at <a href="https://www.codecrunchworldwide.org">Code Crunch Worldwide</a>'s open-source web-development academy.
