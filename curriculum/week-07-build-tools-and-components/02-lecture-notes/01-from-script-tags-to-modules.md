...
Now go scaffold a Vite app, walk through the project shape, and read [`exercise-01-bootstrap-a-vite-app.md`](../03-exercises/exercise-01-bootstrap-a-vite-app.md).
