...
For when running a Docker container is more than you want to take on. All have free tiers usable for learner projects.
...
- **Clerk.** <https://clerk.com/>. React-first developer experience, drop-in `<SignIn />` widget. Free tier suitable for learner work. Documentation at <https://clerk.com/docs>.
