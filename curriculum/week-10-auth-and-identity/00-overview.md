...
| [resources.md](./01-resources.md) | RFCs, OWASP cheat sheets, Keycloak docs, OIDC spec, provider docs |
| [lecture-notes/01-oauth-oidc-and-the-vocabulary.md](./02-lecture-notes/01-oauth-oidc-and-the-vocabulary.md) | What OAuth 2.0 is, what OIDC adds, why OAuth 2.1 deprecated the implicit flow |
| [lecture-notes/02-pkce-jwt-and-the-auth-code-flow.md](./02-lecture-notes/02-pkce-jwt-and-the-auth-code-flow.md) | The PKCE flow walked step by step. JWT anatomy. Signature verification. |
| [lecture-notes/03-sessions-refresh-mfa-and-providers.md](./02-lecture-notes/03-sessions-refresh-mfa-and-providers.md) | Sessions vs. JWTs. Refresh rotation. TOTP. The provider landscape. |
| [exercises/exercise-01-decode-a-jwt.md](./03-exercises/exercise-01-decode-a-jwt.md) | Decode a JWT by hand with `atob`; verify the signature with `jose`; reject a tampered token |
| [exercises/exercise-02-pkce-by-hand.md](./03-exercises/exercise-02-pkce-by-hand.md) | Generate a verifier and challenge in the console; hit Keycloak's authorize and token endpoints with `curl` |
| [exercises/exercise-03-protected-route.md](./03-exercises/exercise-03-protected-route.md) | Wire a React Router protected route that redirects unauthenticated users to the IdP |
| [exercises/starter-jwt-decode.ts](./03-exercises/starter-jwt-decode.ts) | Starter file for exercise 1 |
| [exercises/starter-pkce.ts](./03-exercises/starter-pkce.ts) | Starter file for exercise 2 |
| [exercises/starter-protected-route.jsx](./03-exercises/starter-protected-route.jsx) | Starter file for exercise 3 |
| [exercises/starter-keycloak-realm.json](./03-exercises/starter-keycloak-realm.json) | Minimal Keycloak realm import used in exercises 2 and 3 |
| [exercises/SOLUTIONS.md](./03-exercises/SOLUTIONS.md) | Reference solutions with annotated explanations |
| [challenges/challenge-01-refresh-rotation.md](./04-challenges/challenge-01-refresh-rotation.md) | Implement refresh-token rotation and demonstrate reuse detection trips |
| [challenges/challenge-02-jwks-cache.md](./04-challenges/challenge-02-jwks-cache.md) | Cache the JWKS correctly; handle key rotation without restart |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The SPA-plus-Keycloak end-to-end build |
| [mini-project/starter/docker-compose.yml](./07-mini-project/starter/docker-compose.yml) | Keycloak container plus a dummy resource server |
| [mini-project/starter/keycloak/realm-export.json](./07-mini-project/starter/keycloak/realm-export.json) | The Keycloak realm import — one client, one user |
| [mini-project/starter/package.json](./07-mini-project/starter/package.json) | React + Vite + `oidc-client-ts` + `jose` |
| [mini-project/starter/vite.config.js](./07-mini-project/starter/vite.config.js) | Vite dev server on port 5173 with the callback URL configured |
| [mini-project/starter/index.html](./07-mini-project/starter/index.html) | The SPA shell |
| [mini-project/starter/src/main.jsx](./07-mini-project/starter/src/main.jsx) | React bootstrap |
| [mini-project/starter/src/App.jsx](./07-mini-project/starter/src/App.jsx) | Routes — `/`, `/callback`, `/profile`, `/silent-renew` |
| [mini-project/starter/src/auth.js](./07-mini-project/starter/src/auth.js) | The `UserManager` setup — the one file you spend the most time in |
| [mini-project/starter/src/api.js](./07-mini-project/starter/src/api.js) | Bearer-token fetch wrapper with automatic refresh |
| [mini-project/starter/rubric.md](./07-mini-project/starter/rubric.md) | The grading rubric |
